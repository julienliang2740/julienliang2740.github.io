...
"[project]/julienliang2740.github.io/node_modules/p5/dist/dom/p5.File.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    static _createLoader(theFile, callback) {
        ...
        reader.onload = function(e) {
            ...
            if (p5file.file.type === 'application/json') {
                ...
                p5file.data = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$io$2f$p5$2e$XML$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["XML"](xml.documentElement);
            } else {
...
"[project]/julienliang2740.github.io/node_modules/p5/dist/dom/p5.Element.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class Element {
   ...
   */ size(w, h) {
        if (arguments.length === 0) {
            ...
            let aW = w;
            let aH = h;
            const AUTO$1 = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["w"];
   ...
   */ style(prop, val) {
        const self = this;
        if (val instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$p2iQtNm5$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]) {
            val = val.toString();
        }
        ...
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            ...
            Element._attachListener('drop', function(evt) {
                ...
                for (const f of files){
                    __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$File$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["File"]._load(f, callback);
                }
            }, this);
        } else {
...
"[project]/julienliang2740.github.io/node_modules/p5/dist/dom/p5.MediaElement.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class MediaElement extends __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"] {
    constructor(elt, pInst){
        super(elt, pInst);
        const self = this;
...
function media(p51, fn) {
   ...
   */ function addElement(elt, pInst, media) {
        ...
        const c = media ? new MediaElement(elt, pInst) : new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"](elt, pInst);
...
"[project]/julienliang2740.github.io/node_modules/p5/dist/dom/dom.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function dom(p51, fn) {
   ...
   */ fn._getContainer = function(p) {
        ...
        } else if (p instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"]) {
            container = p.elt;
   ...
   */ fn._wrapElement = function(elt) {
        ...
        if (elt.tagName === 'INPUT' && elt.type === 'checkbox') {
            let converted = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"](elt, this);
            ...
            return new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$MediaElement$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MediaElement"](elt, this);
        } else if (elt.tagName === 'SELECT') {
            return this.createSelect(new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"](elt, this));
        } else if (children.length > 0 && children.every(function(c) {
            return c.tagName === 'INPUT' || c.tagName === 'LABEL';
        }) && (elt.tagName === 'DIV' || elt.tagName === 'SPAN')) {
            return this.createRadio(new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"](elt, this));
        } else {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"](elt, this);
        }
    };
    /**
   ...
   */ function addElement(elt, pInst, media) {
        const node = pInst._userNode ? pInst._userNode : document.body;
        node.appendChild(elt);
        const c = media ? new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$MediaElement$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MediaElement"](elt, pInst) : new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"](elt, pInst);
        pInst._elements.push(c);
        return c;
    }
    /**
   ...
   */ fn.createSelect = function(...args) {
        ...
        let self;
        let arg = args[0];
        if (arg instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"] && arg.elt instanceof HTMLSelectElement) {
   ...
   */ //counter for unique names on radio button
    ...
    fn.createRadio = function(...args) {
        ...
        let name;
        const arg0 = args[0];
        if (arg0 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"] && (arg0.elt instanceof HTMLDivElement || arg0.elt instanceof HTMLSpanElement)) {
   ...
   */ fn.createFileInput = function(callback, multiple = false) {
        ...
        const handleFileSelect = function(event) {
            for (const file of event.target.files){
                __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$File$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["File"]._load(file, callback);
            }
        };
...
"[project]/julienliang2740.github.io/node_modules/p5/dist/dom/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
function dom(p5) {
    p5.registerAddon(__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
    p5.registerAddon(__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
    p5.registerAddon(__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$MediaElement$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
    p5.registerAddon(__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$File$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
}
;
}),
]);

//# sourceMappingURL=1c0e5_p5_dist_dom_3787fdf5._.js.map