...
"[project]/julienliang2740.github.io/node_modules/p5/dist/rendering-CEHgvKUS.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function image(p51, fn) {
   ...
   */ fn.saveCanvas = function(...args) {
        ...
        if (args[0] instanceof HTMLCanvasElement) {
            htmlCanvas = args[0];
            args.shift();
        } else if (args[0] instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"]) {
    ...
    fn.encodeAndDownloadGif = function(pImg, filename) {
        ...
        const gifWriter = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$omggif$2f$omggif$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GifWriter"](buffer, pImg.width, pImg.height, opts);
        let previousFrame = {};
        // Pass 2
...
function files(p51, fn) {
   ...
   */ fn.loadTable = async function(path, separator, header, successCallback, errorCallback) {
        ...
        try {
            ...
            data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$io$2f$csv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parse"])(data, {
                separator
            });
            if (header) {
   ...
   */ fn.save = function(object, _filename, _options) {
        ...
        if (args.length === 0) {
            fn.saveCanvas(cnv);
            return;
        } else if (args[0] instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$DBmMi2eT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"] || args[0] instanceof Graphics) {
            ...
            const extension = (0, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$io$2f$utilities$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_checkFileExtension"])(args[1], args[2])[1];
            switch(extension){
                case 'json':
   ...
   *  @param  {String} [filename]
   *  @param  {String} [extension]
   */ fn.downloadFile = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$io$2f$utilities$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["downloadFile"];
    /**
   ...
   *
   *  @private
   */ fn._checkFileExtension = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$io$2f$utilities$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_checkFileExtension"];
    /**
 ...
 */ function loadingDisplaying(p51, fn) {
   ...
   */ fn.saveGif = async function(fileName, duration, options = {
      ...
      */ this.redraw();
        ...
        const gif = (0, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$gifenc$2f$dist$2f$gifenc$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GIFEncoder"])();
        ...
        const getIndexedFrame = (frame)=>{
            ...
            for(let i = 0; i < length; i++){
                ...
                if (paletteCache[key] === undefined) {
                    paletteCache[key] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$gifenc$2f$dist$2f$gifenc$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["nearestColorIndex"])(globalPalette, frame.slice(i * 4, (i + 1) * 4));
                }
    ...
    function _generateGlobalPalette(frames) {
        ...
        let colorPalette = (0, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$gifenc$2f$dist$2f$gifenc$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["quantize"])(allColors, 256, {
            format: 'rgba4444',
            oneBitAlpha: true
        });
   ...
   */ async function _createGif(arrayBuffer, pImg) {
        ...
        const gifReader = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$omggif$2f$omggif$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GifReader"](arrayBuffer);
   ...
   */ function _imageContain(xAlign, yAlign, dx, dy, dw, dh, sw, sh) {
        ...
        let x = dx;
        let y = dy;
        if (xAlign === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]) {
            x += (dw - adjusted_dw) / 2;
        } else if (xAlign === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"]) {
            x += dw - adjusted_dw;
        }
        if (yAlign === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]) {
            y += (dh - adjusted_dh) / 2;
        } else if (yAlign === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ar"]) {
            y += dh - adjusted_dh;
        }
        return {
            x,
   ...
   */ function _imageFit(fit, xAlign, yAlign, dx, dy, dw, dh, sx, sy, sw, sh) {
        if (fit === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ap"]) {
        ...
        if (fit === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aq"]) {
   ...
   */ fn.image = function(img, dx, dy, dWidth, dHeight, sx, sy, sWidth, sHeight, fit, xAlign, yAlign) {
        ...
        let defW = img.width;
        let defH = img.height;
        yAlign = yAlign || __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"];
        xAlign = xAlign || __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"];
        if (img.elt) {
        ...
        _sh *= pd;
        _sw *= pd;
        let vals = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$core$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].modeAdjust(_dx, _dy, _dw, _dh, this._renderer.states.imageMode);
   ...
   */ fn.imageMode = function(m) {
        ...
        if (m === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"] || m === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["i"] || m === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]) {
 ...
 */ class Camera {
    constructor(renderer){
        ...
        this.cameraMatrix = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](4);
        this.projMatrix = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](4);
        this.yScale = 1;
    }
    ////////////////////////////////////////////////////////////////////////////////
   ...
   */ _rotateView(a, x, y, z) {
        ...
        centerY -= this.eyeY;
        centerZ -= this.eyeZ;
        const rotation = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](4); // TODO Maybe pass p5
   ...
   */ roll(amount) {
        ...
        const axisQuaternion = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Quat$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Quat"].fromAxisAngle(this._renderer._pInst._toRadians(amount), local.z[0], local.z[1], local.z[2]);
        // const upQuat = new p5.Quat(0, this.upX, this.upY, this.upZ);
        const newUpVector = axisQuaternion.rotateVector(new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](this.upX, this.upY, this.upZ));
   ...
   */ slerp(cam0, cam1, amt) {
        ...
        const eye0 = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](cam0.eyeX, cam0.eyeY, cam0.eyeZ);
        const eye1 = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](cam1.eyeX, cam1.eyeY, cam1.eyeZ);
        const center0 = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](cam0.centerX, cam0.centerY, cam0.centerZ);
        const center1 = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](cam1.centerX, cam1.centerY, cam1.centerZ);
        // Calculate the distance between eye and center for each camera.
        // Logarithmically interpolate these with amt.
        const dist0 = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].dist(eye0, center0);
        const dist1 = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].dist(eye1, center1);
        ...
        const eyeDiff = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].sub(eye0, eye1);
        ...
        let ratio = 1; // default.
        if (divider > 0.000001) {
            ratio = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].dot(eyeDiff, diffDiff) / divider;
        ...
        const lerpedMedium = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].lerp(__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].lerp(eye0, center0, ratio), __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].lerp(eye1, center1, ratio), amt);
        ...
        // prepare new vectors.
        const newFront = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]();
        const newUp = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]();
        const newEye = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]();
        const newCenter = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]();
        ...
        if (1 - cosTheta < 0.0000001) {
            ...
            newFront.set(__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].lerp(front0, front1, amt)).normalize();
            ...
            newUp.set(__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].lerp(up0, up1, amt)).normalize();
            // set the camera
        ...
        const ca = c * a;
        // 3x3
        const lerpedRotMat = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"]([
   ...
   */ _orbit(dTheta, dPhi, dRadius) {
        ...
        const front = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](diffX, diffY, diffZ).normalize();
        // up vector. normalized camera's up vector.
        const up = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](this.upX, this.upY, this.upZ).normalize(); // y-axis
        // side vector. Right when viewed from the front
        const side = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].cross(up, front).normalize(); // x-axis
        // vertical vector. normalized vector of projection of front vector.
        const vertical = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].cross(side, up); // z-axis
        // update camRadius
        ...
        const camPhi = Math.acos(Math.max(-1, Math.min(1, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].dot(front, up)))) + dPhi;
   ...
   */ _orbitFree(dx, dy, dRadius) {
        ...
        const up = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](this.upX, this.upY, this.upZ);
        // side vector. Right when viewed from the front. (like x-axis)
        const side = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].cross(up, front).normalize();
        // down vector. Bottom when viewed from the front. (like y-axis)
        const down = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].cross(front, side);
        ...
        const axis = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"].cross(front, side);
        // update camRadius
        camRadius *= Math.pow(10, dRadius);
        // prevent zooming through the center:
        if (camRadius < this.cameraNear) {
...
const defineStrokeCapEnum = function(key, val) {
    ...
    STROKE_CAP_ENUM[__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v"][key]] = val;
};
const defineStrokeJoinEnum = function(key, val) {
    lineDefs += `#define STROKE_JOIN_${key} ${val}\n`;
    STROKE_JOIN_ENUM[__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v"][key]] = val;
};
...
const filterShaderFrags = {
    [__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["X"]]: filterGrayFrag,
    [__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Y"]]: filterErodeFrag,
    [__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["V"]]: filterDilateFrag,
    [__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$"]]: filterBlurFrag,
    [__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["U"]]: filterPosterizeFrag,
    [__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["K"]]: filterOpaqueFrag,
    [__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"]]: filterInvertFrag,
    [__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Z"]]: filterThresholdFrag
};
/**
 * 3D graphics class
 * @private
 ...
 * rendering (FBO).
 */ class RendererGL extends __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$DBmMi2eT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"] {
    constructor(pInst, w, h, isMainCanvas, elt, attr){
        ...
        // Push/pop state
        this.states.uModelMatrix = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](4);
        this.states.uViewMatrix = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](4);
        this.states.uPMatrix = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](4);
        ...
        this.states.curBlendMode = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["u"];
        ...
        this.states._currentNormal = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0, 0, 1);
        this.states.drawMode = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["as"];
        this.states._tex = null;
        this.states.textureMode = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a1"];
        this.states.textureWrapX = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["at"];
        this.states.textureWrapY = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["at"];
        // erasing
        ...
        if (this.webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"]) {
        ...
        this.zoomVelocity = 0;
        this.rotateVelocity = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0, 0);
        this.moveVelocity = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0, 0);
        ...
        this.shapeBuilder = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$ShapeBuilder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShapeBuilder"](this);
        this.buffers = {
            fill: [
                new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](3, 'vertices', 'vertexBuffer', 'aPosition', this, this._vToNArray),
                new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](3, 'vertexNormals', 'normalBuffer', 'aNormal', this, this._vToNArray),
                new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](4, 'vertexColors', 'colorBuffer', 'aVertexColor', this),
                new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](3, 'vertexAmbients', 'ambientBuffer', 'aAmbientColor', this),
                new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](2, 'uvs', 'uvBuffer', 'aTexCoord', this, (arr)=>arr.flat())
            ],
            stroke: [
                new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](4, 'lineVertexColors', 'lineColorBuffer', 'aVertexColor', this),
                new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](3, 'lineVertices', 'lineVerticesBuffer', 'aPosition', this),
                new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](3, 'lineTangentsIn', 'lineTangentsInBuffer', 'aTangentIn', this),
                new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](3, 'lineTangentsOut', 'lineTangentsOutBuffer', 'aTangentOut', this),
                new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](1, 'lineSides', 'lineSidesBuffer', 'aSide', this)
            ],
            text: [
                new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](3, 'vertices', 'vertexBuffer', 'aPosition', this, this._vToNArray),
                new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](2, 'uvs', 'uvBuffer', 'aTexCoord', this, (arr)=>arr.flat())
        ...
        this.geometryBufferCache = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$GeometryBufferCache$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GeometryBufferCache"](this);
        this.curStrokeCap = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["j"];
        this.curStrokeJoin = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["j"];
        ...
        this.scratchMat3 = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](3);
   ...
   */ beginGeometry() {
        ...
        this.geometryBuilder = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$GeometryBuilder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](this);
        this.geometryBuilder.prevFillColor = this.states.fillColor;
        this.fill(new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$p2iQtNm5$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]([
            -1,
            -1,
            -1,
            -1
   ...
   */ buildGeometry(callback) {
    ...
    drawShape(shape) {
        const visitor = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$shape$2f$custom_shapes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PrimitiveToVerticesConverter"]({
        ...
        if (this.geometryBuilder) {
            ...
            if (this.shapeBuilder.shapeMode === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["o"]) {
    ...
    normal(xorv, y, z) {
        if (xorv instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
            this.states.setValue('_currentNormal', xorv);
        } else {
            this.states.setValue('_currentNormal', new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](xorv, y, z));
        }
    ...
    // Rendering
    //////////////////////////////////////////////
    _drawGeometry(geometry, { mode = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p"], count = 1 } = {}) {
        for(const propName in geometry.userVertexProperties){
            const prop = geometry.userVertexProperties[propName];
            this.buffers.user.push(new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$RenderBuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderBuffer"](prop.getDataSize(), prop.getSrcName(), prop.getDstName(), prop.getName(), this));
        }
        if (this.states.fillColor && geometry.vertices.length >= 3 && ![
            __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["L"],
            __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["o"]
        ].includes(mode)) {
    ...
    _drawBuffers(geometry, { mode = this.GL.TRIANGLES, count }) {
        ...
        if (glBuffers.indexBuffer) {
            ...
            if (this._pInst.webglVersion !== __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"] && glBuffers.indexBufferType === gl.UNSIGNED_INT) {
    ...
    _resetContext(options, callback) {
        ...
        if (isPGraphics) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"].call(pg, pg.canvas, pg._pInst);
   ...
   */ getWorldToScreenMatrix() {
        ...
        const projectedToScreenMatrix = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"](4);
   ...
   */ fill(...args) {
        ...
        this.states.setValue('drawMode', __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["as"]);
   ...
   */ stroke(...args) {
    ...
    filter(...args) {
        ...
        if (typeof args[0] === 'string') {
            operation = args[0];
            let useDefaultParam = operation in __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$image$2f$const$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filterParamDefaults"] && args[1] === undefined;
            filterParameter = useDefaultParam ? __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$image$2f$const$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filterParamDefaults"][operation] : args[1];
        ...
        if (operation === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$"]) {
        ...
        this.clear();
        this.push();
        this.states.setValue('imageMode', __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"]);
        this.blendMode(__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["u"]);
   ...
   */ _getTempFramebuffer() {
        if (!this._tempFramebuffer) {
            this._tempFramebuffer = new Framebuffer(this, {
                format: __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["av"],
                useDepth: this._pInst._glAttributes.depth,
                depthFormat: __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["au"],
   ...
   */ clear(...args) {
        ...
        if (activeFramebuffer && activeFramebuffer.format === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["av"] && !activeFramebuffer.antialias && _a === 0) {
   ...
   */ clearDepth(depth = 1) {
    ...
    applyMatrix(a, b, c, d, e, f) {
        ...
        if (arguments.length === 16) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"].prototype.apply.apply(this.states.uModelMatrix, arguments);
        } else {
   ...
   */ translate(x, y, z) {
        if (x instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
            z = x.z;
            y = x.y;
            x = x.x;
        }
   ...
   */ scale(x, y, z) {
    ...
    rotate(rad, axis) {
        ...
        this.states.setValue('uModelMatrix', this.states.uModelMatrix.clone());
        __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"].prototype.rotate4x4.apply(this.states.uModelMatrix, arguments);
        return this;
    }
    rotateX(rad) {
   ...
   */ pointShader() {
    ...
    _getFontShader() {
        if (!this._defaultFontShader) {
            if (this.webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a0"]) {
   ...
   */ _bindBuffer(buffer, target, values, type, usage) {
        ...
        if (values !== undefined) {
            let data = values;
            if (values instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$DataArray$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DataArray"]) {
...
function rendererGL(p51, fn) {
   ...
   */ fn._assert3d = function(name) {
    ...
    p51.renderers[__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a0"]] = p51.RendererGL;
    p51.renderers[__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"]] = p51.RendererGL;
}
/**
 * @private
 ...
 */ fn.strokeMode = function(mode) {
        if (mode === undefined) {
            return this._renderer._simpleLines ? __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aw"] : __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ax"];
        } else if (mode === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aw"]) {
            this._renderer._simpleLines = true;
        } else if (mode === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ax"]) {
   ...
   */ RendererGL.prototype.point = function(x, y, z = 0) {
        const _vertex = [];
        _vertex.push(new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](x, y, z));
    ...
    RendererGL.prototype.triangle = function(args) {
        ...
        if (!this.geometryInHash(gid)) {
            const _triangle = function() {
                const vertices = [];
                vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0, 0, 0));
                vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](1, 0, 0));
                vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0, 1, 0));
                this.edges = [
                    [
                        0,
                        1
            ...
            const triGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](1, 1, _triangle, this);
        ...
        try {
            ...
            const mult = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$Matrices$2f$Matrix$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Matrix"]([
                x2 - x1,
                y2 - y1,
                0,
                0,
    ...
    RendererGL.prototype.ellipse = function(args) {
        this.arc(args[0], args[1], args[2], args[3], 0, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["f"], __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["O"], args[4]);
    };
    RendererGL.prototype.arc = function(...args) {
        ...
        if (Math.abs(stop - start) >= __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["f"]) {
            shape = 'ellipse';
            gid = `${shape}|${detail}|`;
        } else {
            shape = 'arc';
        ...
        if (!this.geometryInHash(gid)) {
            const _arc = function() {
                ...
                if (start.toFixed(10) !== stop.toFixed(10)) {
                    ...
                    if (mode === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aj"] || typeof mode === 'undefined') {
                        this.vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0.5, 0.5, 0));
                        this.uvs.push([
                            0.5,
                            0.5
                        ]);
                    ...
                    for(let i = 0; i <= detail; i++){
                        ...
                        this.vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](_x, _y, 0));
                        this.uvs.push([
                            _x,
                            _y
                        ]);
                    ...
                    switch(mode){
                        case __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aj"]:
                            this.faces.push([
                                0,
                            ...
                            break;
                        case __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ak"]:
                            this.edges.push([
                                0,
                                1
                            ]);
                            ...
                            break;
                        case __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["O"]:
                            this.edges.push([
                                0,
                                1
                            ]);
            ...
            const arcGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](detail, 1, _arc, this);
    ...
    RendererGL.prototype.rect = function(args) {
        ...
        if (typeof args[4] === 'undefined') {
            ...
            if (!this.geometryInHash(gid)) {
                const _rect = function() {
                    for(let i = 0; i <= this.detailY; i++){
                        ...
                        for(let j = 0; j <= this.detailX; j++){
                            ...
                            const p = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](u, v, 0);
                ...
                const rectGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](detailX, detailY, _rect, this);
            ...
            this.states.setValue('textureMode', __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["N"]);
            ...
            this.endShape(__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["n"]);
    ...
    RendererGL.prototype.quad = function(x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4, detailX = 2, detailY = 2) {
        ...
        if (!this.geometryInHash(gid)) {
            const quadGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](detailX, detailY, function() {
                ...
                for(let y = 0; y < this.detailY; y++){
                    for(let x = 0; x < this.detailX; x++){
                        ...
                        this.vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](ptx, pty, ptz));
                        this.uvs.push([
                            pctx,
                            pcty
                        ]);
   ...
   */ RendererGL.prototype.line = function(...args) {
        if (args.length === 6) {
            ...
            this.beginShape(__TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["L"]);
   ...
   */ const _truncatedCone = function(bottomRadius, topRadius, height, detailX, detailY, bottomCap, topCap) {
        ...
        for(yy = start; yy <= end; ++yy){
            ...
            for(ii = 0; ii < detailX; ++ii){
                ...
                //VERTICES
                this.vertices.push(new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](sur * ringRadius, y, cur * ringRadius));
                //VERTEX NORMALS
                let vertexNormal;
                if (yy < 0) {
                    vertexNormal = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0, -1, 0);
                } else if (yy > detailY && topRadius) {
                    vertexNormal = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](0, 1, 0);
                } else {
                    vertexNormal = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](sur * cosSlant, sinSlant, cur * cosSlant);
                }
        ...
        if (!this.geometryInHash(gid)) {
            const _plane = function() {
                ...
                for(let i = 0; i <= this.detailY; i++){
                    ...
                    for(let j = 0; j <= this.detailX; j++){
                        u = j / this.detailX;
                        p = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](u - 0.5, v - 0.5, 0);
                        this.vertices.push(p);
                        this.uvs.push(u, v);
                    }
                }
            };
            const planeGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](detailX, detailY, _plane, this);
    ...
    RendererGL.prototype.box = function(width = 50, height = width, depth = height, detailX, detailY) {
        ...
        if (!this.geometryInHash(gid)) {
            const _box = function() {
                ...
                cubeIndices.forEach((cubeIndex, i)=>{
                    ...
                    for(let j = 0; j < 4; j++){
                        ...
                        const octant = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](((d & 1) * 2 - 1) / 2, ((d & 2) - 1) / 2, ((d & 4) / 2 - 1) / 2);
            ...
            const boxGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](detailX, detailY, _box, this);
    ...
    RendererGL.prototype.ellipsoid = function(radiusX = 50, radiusY = radiusX, radiusZ = radiusX, detailX = 24, detailY = 16) {
        ...
        if (!this.geometryInHash(gid)) {
            ...
            const ellipsoidGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](detailX, detailY, _ellipsoid, this);
    ...
    RendererGL.prototype.cone = function(radius = 50, height = radius, detailX = 24, detailY = 1, cap = true) {
        ...
        if (!this.geometryInHash(gid)) {
            const coneGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](detailX, detailY, function() {
    ...
    RendererGL.prototype.torus = function(radius = 50, tubeRadius = 10, detailX = 24, detailY = 16) {
        ...
        if (!this.geometryInHash(gid)) {
            const _torus = function() {
                for(let i = 0; i <= this.detailY; i++){
                    ...
                    for(let j = 0; j <= this.detailX; j++){
                        ...
                        const cosTheta = Math.cos(theta);
                        const sinTheta = Math.sin(theta);
                        const p = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](r * cosTheta, r * sinTheta, tubeRatio * sinPhi);
                        const n = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](cosPhi * cosTheta, cosPhi * sinTheta, sinPhi);
                        this.vertices.push(p);
            ...
            const torusGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$webgl$2f$p5$2e$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"](detailX, detailY, _torus, this);
 ...
 */ function light(p51, fn) {
   ...
   */ fn.noLights = function(...args) {
    ...
    RendererGL.prototype.directionalLight = function(v1, v2, v3, x, y, z) {
        let color;
        if (v1 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$p2iQtNm5$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]) {
            color = v1;
        } else {
    ...
    RendererGL.prototype.spotLight = function(v1, v2, v3, x, y, z, nx, ny, nz, angle, concentration) {
        ...
        switch(length){
            ...
            case 10:
                color = this._pInst.color(v1, v2, v3);
                position = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](x, y, z);
                direction = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](nx, ny, nz);
                break;
            case 9:
                if (v1 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$p2iQtNm5$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]) {
                    color = v1;
                    position = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](v2, v3, x);
                    direction = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](y, z, nx);
                    angle = ny;
                    concentration = nz;
                } else if (x instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
                    color = this._pInst.color(v1, v2, v3);
                    position = x;
                    direction = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](y, z, nx);
                    angle = ny;
                    concentration = nz;
                } else if (nx instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
                    color = this._pInst.color(v1, v2, v3);
                    position = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](x, y, z);
                    direction = nx;
                    angle = ny;
            ...
            case 8:
                ...
                break;
            case 7:
                if (v1 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$p2iQtNm5$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"] && v2 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
                    color = v1;
                    position = v2;
                    direction = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](v3, x, y);
                    angle = z;
                    concentration = nx;
                } else if (v1 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$p2iQtNm5$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"] && y instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
                    color = v1;
                    position = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](v2, v3, x);
                    direction = y;
                    angle = z;
                    concentration = nx;
                } else if (x instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"] && y instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
                    color = this._pInst.color(v1, v2, v3);
                    position = x;
                    direction = y;
                    angle = z;
                    concentration = nx;
                } else if (v1 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$p2iQtNm5$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]) {
                    color = v1;
                    position = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](v2, v3, x);
                    direction = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"](y, z, nx);
                } else if (x instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
                ...
                break;
            case 6:
                if (x instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"] && y instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
                    color = this._pInst.color(v1, v2, v3);
                    position = x;
                    direction = y;
                    angle = z;
                ...
                break;
            case 5:
                if (v1 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$p2iQtNm5$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"] && v2 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"] && v3 instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$p5$2e$Vector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector"]) {
                    color = v1;
                    position = v2;
                    direction = v3;
                    angle = x;
 ...
 */ function material(p51, fn) {
   ...
   */ fn.textureMode = function(mode) {
        if (mode !== __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a1"] && mode !== __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["N"]) {
   ...
   */ fn.ambientMaterial = function(v1, v2, v3) {
        ...
        if (!this._renderer.states.fillColor) {
            this._renderer.states.setValue('fillColor', new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$p2iQtNm5$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]([
                1,
                1,
                1
            ]));
   ...
   */ RendererGL.prototype._applyColorBlend = function(colors, hasTransparency) {
        const gl = this.GL;
        const isTexture = this.states.drawMode === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"];
        const doBlend = hasTransparency || this.states.userFillShader || this.states.userStrokeShader || this.states.userPointShader || isTexture || this.states.curBlendMode !== __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["u"] || colors[colors.length - 1] < 1.0 || this._isErasing;
        if (doBlend !== this._isBlending) {
            if (doBlend || this.states.curBlendMode !== __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["u"] && this.states.curBlendMode !== __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ai"]) {
                gl.enable(gl.BLEND);
            } else {
                gl.disable(gl.BLEND);
            }
   ...
   */ RendererGL.prototype._applyBlendMode = function() {
        ...
        switch(this.states.curBlendMode){
            case __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["u"]:
                gl.blendEquation(gl.FUNC_ADD);
                gl.blendFunc(gl.ONE, gl.ONE_MINUS_SRC_ALPHA);
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ai"]:
                gl.blendEquation(gl.FUNC_ADD);
                gl.blendFunc(gl.ONE, gl.ONE);
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a4"]:
                gl.blendEquation(gl.FUNC_ADD);
                gl.blendFunc(gl.ZERO, gl.ONE_MINUS_SRC_ALPHA);
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a9"]:
                gl.blendEquation(gl.FUNC_ADD);
                gl.blendFunc(gl.DST_COLOR, gl.ONE_MINUS_SRC_ALPHA);
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ab"]:
                gl.blendEquation(gl.FUNC_ADD);
                gl.blendFunc(gl.ONE, gl.ONE_MINUS_SRC_COLOR);
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aa"]:
                gl.blendEquationSeparate(gl.FUNC_ADD, gl.FUNC_ADD);
                gl.blendFuncSeparate(gl.ONE_MINUS_DST_COLOR, gl.ONE_MINUS_SRC_COLOR, gl.ONE, gl.ONE);
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ac"]:
                gl.blendEquation(gl.FUNC_ADD);
                gl.blendFunc(gl.ONE, gl.ZERO);
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a5"]:
                gl.blendEquationSeparate(gl.FUNC_REVERSE_SUBTRACT, gl.FUNC_ADD);
                gl.blendFuncSeparate(gl.ONE, gl.ONE, gl.ONE, gl.ONE_MINUS_SRC_ALPHA);
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a6"]:
                if (this.blendExt) {
                ...
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a7"]:
                if (this.blendExt) {
    ...
    RendererGL.prototype.texture = function(tex) {
        this.states.setValue('drawMode', __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"]);
        this.states.setValue('_useNormalMaterial', false);
        this.states.setValue('_tex', tex);
        this.states.setValue('fillColor', new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$p2iQtNm5$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"]([
            1,
            1,
            1
        ]));
 ...
 */ class Graphics {
    constructor(w, h, renderer, pInst, canvas){
        const r = renderer || __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["P"];
        this._pInst = pInst;
...
function graphics(p51, fn) {
   ...
   */ p51.Graphics = Graphics;
    // Shapes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$shape$2f$2d_primitives$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$shape$2f$attributes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$shape$2f$curves$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$shape$2f$vertex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$shape$2f$custom_shapes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$color$2f$setting$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
    loadingDisplaying(p51, p51.Graphics.prototype);
    image(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$image$2f$pixels$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$core$2f$transform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
    primitives3D(p51, p51.Graphics.prototype);
    light(p51, p51.Graphics.prototype);
    material(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$p2iQtNm5$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(p51, p51.Graphics.prototype);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$math$2f$trigonometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(p51, p51.Graphics.prototype);
}
/**
 ...
 */ class Texture {
    constructor(renderer, obj, settings){
        ...
        this.isSrcHTMLElement = typeof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"] !== 'undefined' && obj instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$dom$2f$p5$2e$Element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Element"] && !(obj instanceof Graphics) && !(obj instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$DBmMi2eT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"]);
        this.isSrcP5Image = obj instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$DBmMi2eT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["I"];
        this.isSrcP5Graphics = obj instanceof Graphics;
        this.isSrcP5Renderer = obj instanceof __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$DBmMi2eT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"];
   ...
   */ setInterpolation(downScale, upScale) {
    ...
    glFilter(filter) {
        const gl = this._renderer.GL;
        if (filter === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ay"]) {
            return gl.NEAREST;
        } else {
            return gl.LINEAR;
        }
   ...
   */ setWrapMode(wrapX, wrapY) {
        ...
        if (wrapX === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["az"]) {
            if (this._renderer.webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"] || widthPowerOfTwo && heightPowerOfTwo) {
        ...
        } else if (wrapX === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aA"]) {
            if (this._renderer.webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"] || widthPowerOfTwo && heightPowerOfTwo) {
        ...
        if (wrapY === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["az"]) {
            if (this._renderer.webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"] || widthPowerOfTwo && heightPowerOfTwo) {
        ...
        } else if (wrapY === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aA"]) {
            if (this._renderer.webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"] || widthPowerOfTwo && heightPowerOfTwo) {
...
function checkWebGLCapabilities({ GL, webglVersion }) {
    const gl = GL;
    const supportsFloat = webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"] ? gl.getExtension('EXT_color_buffer_float') && gl.getExtension('EXT_float_blend') : gl.getExtension('OES_texture_float');
    const supportsFloatLinear = supportsFloat && gl.getExtension('OES_texture_float_linear');
    const supportsHalfFloat = webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"] ? gl.getExtension('EXT_color_buffer_float') : gl.getExtension('OES_texture_half_float');
...
class Framebuffer {
    constructor(renderer, settings = {}){
        ...
        this.pixels = [];
        this.format = settings.format || __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["av"];
        this.channels = settings.channels || (this.renderer._pInst._glAttributes.alpha ? __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$p2iQtNm5$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"] : __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$p2iQtNm5$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"]);
        this.useDepth = settings.depth === undefined ? true : settings.depth;
        this.depthFormat = settings.depthFormat || __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aB"];
        this.textureFiltering = settings.textureFiltering || __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aC"];
        ...
        if (this.antialias && this.renderer.webglVersion !== __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"]) {
   ...
   */ _checkIfFormatsAvailable() {
        const gl = this.gl;
        if (this.useDepth && this.renderer.webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a0"] && !gl.getExtension('WEBGL_depth_texture')) {
            console.warn('Unable to create depth textures in this environment. Falling back ' + 'to a framebuffer without depth.');
            this.useDepth = false;
        }
        if (this.useDepth && this.renderer.webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a0"] && this.depthFormat === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aB"]) {
            console.warn('FLOAT depth format is unavailable in WebGL 1. ' + 'Defaulting to UNSIGNED_INT.');
            this.depthFormat = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["au"];
        }
        if (![
            __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["av"],
            __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aB"],
            __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aD"]
        ].includes(this.format)) {
            console.warn('Unknown Framebuffer format. ' + 'Please use UNSIGNED_BYTE, FLOAT, or HALF_FLOAT. ' + 'Defaulting to UNSIGNED_BYTE.');
            this.format = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["av"];
        }
        if (this.useDepth && ![
            __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["au"],
            __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aB"]
            ...
            this.depthFormat = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aB"];
        }
        const support = checkWebGLCapabilities(this.renderer);
        if (!support.float && this.format === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aB"]) {
            console.warn('This environment does not support FLOAT textures. ' + 'Falling back to UNSIGNED_BYTE.');
            this.format = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["av"];
        }
        if (this.useDepth && !support.float && this.depthFormat === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aB"]) {
            console.warn('This environment does not support FLOAT depth textures. ' + 'Falling back to UNSIGNED_INT.');
            this.depthFormat = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["au"];
        }
        if (!support.halfFloat && this.format === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aD"]) {
            console.warn('This environment does not support HALF_FLOAT textures. ' + 'Falling back to UNSIGNED_BYTE.');
            this.format = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["av"];
        }
        if (this.channels === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$p2iQtNm5$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["R"] && [
            __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aB"],
            __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aD"]
        ].includes(this.format)) {
            console.warn('FLOAT and HALF_FLOAT formats do not work cross-platform with only ' + 'RGB channels. Falling back to RGBA.');
            this.channels = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$p2iQtNm5$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"];
        }
    }
    /**
   ...
   */ _recreateTextures() {
        ...
        const filter = this.textureFiltering === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aC"] ? gl.LINEAR : gl.NEAREST;
   ...
   */ _glColorFormat() {
        ...
        const gl = this.gl;
        if (this.format === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aB"]) {
            type = gl.FLOAT;
        } else if (this.format === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aD"]) {
            type = this.renderer.webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"] ? gl.HALF_FLOAT : gl.getExtension('OES_texture_half_float').HALF_FLOAT_OES;
        } else {
            type = gl.UNSIGNED_BYTE;
        }
        if (this.channels === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$creating_reading$2d$p2iQtNm5$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"]) {
            format = gl.RGBA;
        } else {
            format = gl.RGB;
        }
        if (this.renderer.webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"]) {
   ...
   */ _glDepthFormat() {
        ...
        const gl = this.gl;
        if (this.useStencil) {
            if (this.depthFormat === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aB"]) {
                type = gl.FLOAT_32_UNSIGNED_INT_24_8_REV;
            } else if (this.renderer.webglVersion === __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"]) {
   ...
   */ get(x, y, w, h) {
        ...
        const region = new __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$p5$2e$Renderer$2d$DBmMi2eT$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["I"](w * this.density, h * this.density);
   ...
   */ updatePixels() {
        ...
        if (this.antialias) {
            ...
            this.renderer.states.setValue('imageMode', __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"]);
...
function rendering(p51, fn) {
   ...
   */ fn.createCanvas = function(w, h, renderer, ...args) {
        ...
        let selectedRenderer = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["P"];
   ...
   */ fn.createGraphics = function(w, h, ...args) {
     ...
     */ if (args[0] instanceof HTMLCanvasElement) {
            args[1] = args[0];
            args[0] = __TURBOPACK__imported__module__$5b$project$5d2f$julienliang2740$2e$github$2e$io$2f$node_modules$2f$p5$2f$dist$2f$constants$2d$ClrEsgSR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["P"];
        }
...
//# sourceMappingURL=1c0e5_p5_dist_rendering-CEHgvKUS_c76c056a.js.map