  ...
  return (
    <>
      ...
      <section className={sectionCls}>
        ...
        <p className={paragraphCls}>If you play Polytopia competitively, try PolyTerminal.</p>

        <p className={paragraphCls}>Break it.</p>
        <p className={paragraphCls}>Stress test it.</p>
        <p className={paragraphCls}>Tell me what’s missing.</p>
        ...
        <p className={paragraphCls}>PolyTerminal started because I was losing.</p>

        <p className={paragraphCls}>It evolved because patterns emerged.</p>

        <p className={paragraphCls}>
          It continues because competitive systems reward structured thinking.
        </p>

        <p className={paragraphCls}>Games are systems.</p>

        <p className={paragraphCls}>Systems can be modeled.</p>
